        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Submit, monitor, and resolve community issues — roads, sanitation, water, electricity, and more.
            </p>
          </motion.div>

          <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible">
            <button
              className="px-8 py-3 rounded-full bg-white/[0.08] border border-white/[0.15] text-white/80 text-sm font-medium tracking-wide hover:bg-white/[0.12] transition-colors"
